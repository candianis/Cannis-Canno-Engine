...
namespace Cannis {
	...
	public:
		...
		void addShader(const ShaderSlot p_shaderSlot, const string& p_vertexName, const string& p_fragmentName);
		...
		void addShader(const ShaderSlot p_shaderSlot, const string& p_vertexName, const string& p_fragmentName, const string& p_geometryShader);
		...
		void addShader(const ShaderSlot p_shaderSlot, const Shader& p_newShader);

		const shared_ptr<Shader> getShader(const ShaderSlot p_shaderSlot) const;

		// @brief Activates a shader
		// @param p_shaderSlot Slot of the shader that will be used
		void useShader(const ShaderSlot p_shaderSlot) const;
		...
		void setBool(const ShaderSlot p_shaderSlot, const string& p_valueName, const bool p_value) const;

		// @brief Set a uniform int value to a shader
		// @param p_shaderSlot Slot of the shader that will be used
		// @param p_valueName Name of the uniform inside the shader
		// @param p_value Value that will be assigned to the uniform
		void setInt(const ShaderSlot p_shaderSlot, const string& p_valueName, int p_value) const;
		
		// @brief Set a uniform float value to a shader
		// @param p_shaderSlot Slot of the shader that will be used
		// @param p_valueName Name of the uniform inside the shader
		// @param p_value Value that will be assigned to the uniform
		void setFloat(const ShaderSlot p_shaderSlot, const string& p_valueName, float p_value) const;
		
		// @brief Set a uniform Vector3 (3 floats) value to a shader
		// @param p_shaderSlot Slot of the shader that will be used
		// @param p_valueName Name of the uniform inside the shader
		// @param p_value Value that will be assigned to the uniform
		void setVec3(const ShaderSlot p_shaderSlot, const string& p_valueName, const glm::vec3& p_value) const;
		...
		void setVec3(const ShaderSlot p_shaderSlot, const string& p_valueName, float p_x, float p_y, float p_z) const;
		
		// @brief Set a uniform Matrix3x3 (floats) value to a shader
		// @param p_shaderSlot Slot of the shader that will be used
		// @param p_valueName Name of the uniform inside the shader
		// @param p_value Value that will be assigned to the uniform
		void setMatrix3(const ShaderSlot p_shaderSlot, const string& p_valueName, glm::mat3& p_value) const;
		
		// @brief Set a uniform Matrix4x4 (floats) value to a shader
		// @param p_shaderSlot Slot of the shader that will be used
		// @param p_valueName Name of the uniform inside the shader
		// @param p_value Value that will be assigned to the uniform
		void setMatrix4(const ShaderSlot p_shaderSlot, const string& p_valueName, glm::mat4& p_value) const;
	...
	private:
		...
		unordered_map<ShaderSlot, shared_ptr<Shader>> m_shaders;
	};
}